...
final class GpuFluidSceneTest {
    @Test
    void packsBlockLookupResolvedQuadAndUnlitTintData() {
        FluidGeometrySnapshot water = fluid(
                "minecraft:water", -1, 66, 33, true, 0xFF3F76E4,
                15.0F, 2.75F, 1.0F,
                16.0F, 2.50F, 1.0F,
                16.0F, 2.50F, 2.0F,
                15.0F, 2.75F, 2.0F,
    ...
    void waterloggedCellDoesNotSetFluidOnlyFlag() {
        FluidGeometrySnapshot waterlogged = fluid(
                "minecraft:water", 0, 64, 0, false, 0xFF3F76E4,
        ...
        assertEquals(0xFF3F76E4, word(buffer, GpuFluidScene.CELL_DESCRIPTOR_BASE_WORD + 8));
    }
    ...
    private static FluidGeometrySnapshot flatWater(int x, int y, int z) {
        ...
        float lz = z - sz * 16.0F;
        return fluid(
                "minecraft:water", x, y, z, true, 0xFF3F76E4,
                lx, ly, lz,
                lx + 1.0F, ly, lz,
                lx + 1.0F, ly, lz + 1.0F,
                lx, ly, lz + 1.0F,
    ...
    private static FluidGeometrySnapshot fluid(
            String id, int x, int y, int z, boolean fluidOnly, int tintArgb,
        ...
        return new FluidGeometrySnapshot(
                "minecraft:overworld", id, x, y, z, fluidOnly, tintArgb,
