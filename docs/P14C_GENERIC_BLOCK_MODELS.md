...
| Alpha-cutout silhouette | **Pending material/texture integration** | texture alpha | Plant/leaf/cross-plane geometry exists as quads, but transparent pixels within a quad are not yet alpha-tested by ray traversal. |
